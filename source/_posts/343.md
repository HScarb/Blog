...
![jmeter template](343/2019-02-14_15-30-57.png)

这里创建一个web测试计划模板。

![jmeter template info](343/2019-02-14_15-33-56.png)

我用到比较多的是将流量列表存到csv文件里面，用jmeter去依次读取csv文件中的流量，进行回放。
这需要用到`CSV Data Set Config`

![csv data set config](343/2019-02-14_16-53-11.png)
